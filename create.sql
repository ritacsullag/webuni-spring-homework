...
create table student (balance integer not null, date_of_birth date, semester integer not null, used_free_semester integer, central_id bigint not null, id bigint not null, name varchar(255), primary key (id));
create table student_aud (balance integer, date_of_birth date, rev integer not null, revtype smallint, semester integer, used_free_semester integer, central_id bigint, id bigint not null, name varchar(255), primary key (rev, id));
